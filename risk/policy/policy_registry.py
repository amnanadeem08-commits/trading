...
class PolicyRegistry:
    """Thread-safe registry for risk policy definitions and implementations."""

    def __init__(self) -> None:
        self._lock = RLock()
        self._policies: dict[str, PolicyMetadata] = {}
        self._types: dict[str, type[RiskPolicy]] = {}
    ...
    def register_type(self, policy_type: type[RiskPolicy]) -> None:
    ...
    def resolve_type(self, policy_id: str) -> type[RiskPolicy]:
        with self._lock:
