"""
Central config. Tweak here, don't hunt through the codebase.
"""

# --- Universe selection ---
# MARKET can be "crypto" or "psx". You can also pass --market on the CLI.
MARKET = "both"
TOP_N = 20                      # how many assets to scan
QUOTE_CURRENCY = "USDT"         # crypto: trade against USDT pairs
EXCHANGE_ID = "binance"

# PSX symbols use Yahoo Finance's Karachi suffix (.KA).
PSX_SYMBOLS = [
    "HBL.KA", "UBL.KA", "MCB.KA", "NBP.KA", "BAFL.KA",
    "OGDC.KA", "PPL.KA", "POL.KA", "MARI.KA",
    "LUCK.KA", "DGKC.KA", "MLCF.KA",
    "ENGRO.KA", "FFC.KA", "EFERT.KA",
    "HUBC.KA", "KAPCO.KA", "PSO.KA", "SNGP.KA", "SYS.KA",
]
